...
const MightLikeMachineCard = () => {
    return (
        <div className='relative w-full mx-auto overflow-hidden h-[475px] bg-primary rounded-2xl shadow-2xl'>
            <div className='w-[424px] lg:w-[525px] h-[305px] rounded-t-2xl relative flex items-center justify-center overflow-hidden' >
                <img
                    src={machineImg}
                    alt="hero"
...
export default memo(MightLikeMachineCard);